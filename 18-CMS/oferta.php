        ...
        <section class="sekcja1">
            <div class="container-fluid container">
                ...
                <?php if ($userGroup == 'admin') { ?>
                    ...
                    <br />
                    <form method="post" action="x-controller-edit-offer.php">
                        <input type="hidden" name="id_cms" value="1" />
                        <textarea id="editor" name="content"><?= htmlspecialchars($ofertaText) ?></textarea>
                ...
                <?php } else {
                    echo htmlspecialchars_decode($ofertaText);
                } ?>
            </div>
        </section>
    </main>
