...
<body onload="autoSubmitForm()" class="text-center background-first">
    <div class="form-register background-second">
        ...
        <form class="form-signin form-register" method="post" action="logInScript.php">
            <?php
            session_start();
        ...
        <div class="mb-3">
            <span class="color-text-icon">Nie masz jeszcze konta? <a id="link" href="register.php">Zarejestruj się</a> tutaj</span>
            <br>
