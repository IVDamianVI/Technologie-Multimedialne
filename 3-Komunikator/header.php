    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
        <div class="container">
            ...
            <a class="navbar-brand" href="index.php">
                <img src="media/favicon/favicon-orange.png" id="logo" alt="Logo" style="margin-top: -1px; margin-left: 2px;" />
            </a>
            <!-- Toggle button END -->
            ...
            <div class="collapse navbar-collapse align-items-center" id="navbarButtons" toggle="collapse" data-target=".navbar-collapse">
            ...
            <div class="pc-only">
                <div class="dropdown">
                    <img src="media/avatar/<?php echo $_SESSION['avatar']; ?>" alt="Avatar" style="margin-top: -1px; margin-left: 2px;" id="account" data-bs-toggle="dropdown" class="mx-auto rounded-circle img-end d-block" />
                    <ul class="dropdown-menu dropdown-menu-end mt-2 mb-2" style="background-color: #0e0e0e !important; border: 2px solid #151515; border-radius: 15px !important;">
                        <li style="margin-left: 15px; margin-right: 15px; margin-top: 15px;">
                            ...
                            <a href="profile.php" id="showProfile" class="text-top" style="line-height: 0px; margin: 0; padding: 0;">
                                <p>Zobacz profil</p>
                            </a>
                        </li>
                        <!-- Przycisk do chatu -->
