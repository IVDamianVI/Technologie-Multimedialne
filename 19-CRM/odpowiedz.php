...
if ($question_id) {
    $sql = "SELECT pytanie FROM zapytania WHERE id = ?";
    ...
    <main>
        <section class="sekcja1">
            <div class="container">
                ...
                <form method="POST" action="odpowiedzScript.php">
                    <input type="hidden" name="question_id" value="<?php echo htmlspecialchars($question_id); ?>">
                    <input type="hidden" name="pracownik_id" value="<?php echo $_SESSION['userid']; ?>">
                    ...
                    <div class="form-group">
                        <label for="answer" style="color: #ff9000;">Odpowiedź</label>
