...
<body onload="myLoadHeader(); autoSubmitForm()">
    ...
    <main>
        <div class="content">
            <div class="container">
                <form method="POST" action="spotifyUploadScript.php" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <br/>
                    <div class="form-group">
                        <label for="musician">Wykonawca</label>
                        <input type="text" class="form-control" id="musician" name="musician" placeholder="Wykonawca"
                        required>
                    </div>
                    <br/>
                    <div class="form-group">
                        <label for="lyrics">Tekst</label>
                        <textarea class="form-control" id="lyrics" name="lyrics" placeholder="Tekst utworu"
                            rows="3"></textarea>
                    </div>
                    <br/>
                    <div class="form-group">
                        ...
                        <select name="musictypeid" required>
                            ...
                            $result = mysqli_query($dbConn, 'SELECT * FROM musictype ORDER BY id ASC');
