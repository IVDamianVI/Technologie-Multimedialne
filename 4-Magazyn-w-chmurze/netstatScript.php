...
function catchExceptions($err){
	global $config;
	echo "Błąd w Twoim żądaniu! Spróbuj ponownie później.  " .
		"Jeśli problem będzie się powtarzał skontaktuj się z <a href=\"".$config['contact']."\">".$config['contact']."</a>.";
...
function defaultConfig(){
	$config=array();
	$config['version'] = '';
    // ~ git master zmodyfikowany przez Damian Grubecki ~
	$config['description'] = "Status online hostów i usług dostarczanych przez netstat.php";
	...
	$config['checks'] = array(
	     ...
	     'Testy <a style="color: #000000;" href="../">ivdamianvi.smallhost.pl</a> |headline',
	 'www.ivdamianvi.smallhost.pl | ping| ICMP ping (ping)',
	 'www.ivdamianvi.smallhost.pl |  80 | HTTP server (port 80)',
	 'www.ivdamianvi.smallhost.pl | 443 | HTTPS server (SSL, port 443)',
	 'www.ivdamianvi.smallhost.pl |  22 | SSH server (port 22)',
	 'www.ivdamianvi.smallhost.pl |  21 | FTP server (port 21)',
	 '-------------------------------------------------',
	    'Więcej przykładów |headline',
...
function html($cache){
	...
	echo '<h1 id="statusHeadline" class="shine">'.$config['headline'].'</h1>';
