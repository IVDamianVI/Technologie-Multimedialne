...
<body class="text-center background-first">
    <div class="form-register background-second">
        ...
        <form class="form-signin form-register" action="changeAvatarScript.php" method="post" enctype="multipart/form-data">
            <?php
            ...
            <div style="margin-top: -15px">
                <img src="media/avatar/<?php echo $_SESSION['avatar']; ?>" id="account" data-bs-toggle="dropdown" class="mx-auto rounded-circle img-end d-block" />
