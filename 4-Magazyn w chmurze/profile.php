...
session_start(); // zapewnia dostęp do changeny sesyjnych w danym pliku
...
<body onload="myLoadHeader(); autoSubmitForm()">
    ...
    <main>
        <section class="sekcja1" data-bs-theme="dark">
            <div class="container">
                <div class="container banner" style='background-color: #000000; background-image: url("media/banner/<?php echo $_SESSION['banner']; ?>"); background-size: cover; background-repeat: no-repeat; background-position: center center; box-shadow: inset 0px -140px 140px -70px #000000;'>
                    <a href="changeBanner.php">
                        ...
                        <div class="row align-items-end">
                            <div class="col avatarImage" style="max-width: 12.5em !important;">
                                <a id="changeAvatar" href="changeAvatar.php">
                                    ...
                                    <img id="changeAvatarImg" src="media/avatar/<?php echo $_SESSION['avatar']; ?>" alt="Avatar" style="background-color: #161616; width: 12em; height: 12em; margin: 0; padding: 0;" />
                                </a>
                            </div>
                            <div class="col" style="text-align: left;">
                                <span style="color: #ffffff; font-weight:bold; font-size: 2em;"><?php echo $_SESSION['user']; ?></span><br>
                                <!-- <span style="color: #ffffff; font-size: 1em;"><?php echo $countryName ?></span><br> -->
                                <span style="color: #ffffff; font-size: 1em;">Utworzono: <?php echo $created ?></span>
                            </div>
                        </div>
                    </div>
                </div>
